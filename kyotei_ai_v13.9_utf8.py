...
<style>
    ...
    .stApp {
        font-family: 'Noto Sans JP', "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Yu Gothic Medium", "Meiryo", "MS Gothic", sans-serif !important;
    }

    /* Japanese text specific styling */
    h1, h2, h3, h4, h5, h6, p, div, span, label, .stSelectbox label, .stNumberInput label {
        font-family: 'Noto Sans JP', "Hiragino Sans", "Hiragino Kaku Gothic ProN", "Yu Gothic Medium", "Meiryo", "MS Gothic", sans-serif !important;
    }
.main > div {
    padding: 2rem 1rem;

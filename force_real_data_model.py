...
# 元のapp.pyを完全にバックアップ
import shutil
shutil.copy('app.py', 'app_sample_backup.py')
...
with open('app.py', 'w', encoding='utf-8') as f:
    f.write(real_data_app)

print("✅ 実データ専用アプリに完全置換完了")
print("📝 変更内容:")
print("  - サンプル版完全削除")
print("  - 実データモデル(practical_kyotei_model.pkl)強制使用")  
print("  - 学習レース数: 2,346レース表示")
print("  - 動的オッズ計算（個別値）")
print("  - 超詳細AI根拠")
print("  - note記事生成修正")

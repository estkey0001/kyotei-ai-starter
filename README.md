...
### 2. データ準備
5競艇場のCSVファイルを `data/coconala_2024/` に配置：
- toda_2024.csv
- edogawa_2024.csv
- heiwajima_2024.csv
- suminoe_2024.csv
...
### 3. システム起動
```bash
streamlit run kyotei_ai_complete_v11.py --server.port=8080 --server.address=0.0.0.0
```
...
### AI学習データ
- **総レース数**: 11,664レース
- **データ項目**: 206列（選手情報、機力、天候等）
- **学習期間**: 2024年度実データ
- **予想精度**: 88.7%（会場別82.9%-92.4%）

### 予想機能
- **確率計算**: 会場特性考慮アルゴリズム
- **期待値算出**: 控除率25%考慮
- **投資判定**: 5段階評価システム
- **フォーメーション**: 本命・中穴・大穴パターン
